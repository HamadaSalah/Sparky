...
@section('content')
<h2 style="padding-bottom: 35px;float: left;margin-top: 0">Opportunities Categories</h2>
<a href="{{route('admin.oppocats.create')}}">  
    <button class="btn btn-primary" style="float: right"><i class="fa fa-plus"> </i>New Opportunity</button>
</a>
...
<div class="table-responsive">
    <table class="table user-table no-wrap" id="myDTable">
        ...
        <tbody>
            ...
            <td>
                <a href="{{route('admin.oppocats.edit', $category->id)}}">
                    <button class="btn btn-success" type="submit"><i class="fas fa-edit"></i> Edit</button>
                </a>   
                    <form style="display: inline;" action="{{route('admin.oppocats.destroy', $category->id)}}" method="post">
                        @csrf
                        @method('DELETE')
