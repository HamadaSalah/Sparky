...
@section('content')
<h2 style="padding-bottom: 35px;float: left;margin-top: 0">All Opportunities</h2>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <td>
                    <form style="display: inline;" action="{{route('admin.opportunities.destroy', $new->id)}}" method="post">
                        @csrf
                        @method('DELETE')
                        <button class="btn btn-danger" type="submit"><i class="fa fa-trash"></i> Delete</button>
                    </form>
                    <a href="{{Route('admin.opportunities.edit', $new->id)}} ">
