        ...
        <main>
            <div id="details" class="clearfix">
                <div id="client">
                    ...
                    <div id="invoice">
                        <h1><img style="width: 100px" src="{{ asset('photos/'.$user->photo) }}"
                                alt=""></h1>
                    </div>
                </div>
                <table border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                        ...
                        <tr>
                            <td class="no">Skills</td>
                            <td class="desc">{{ $user->skills }}</td>
                        </tr>

                        <tr>
                            <td class="no">Visa</td>
                            <td class="desc">{{ $user->visa }}</td>
                        </tr>

                        <tr>
                            <td class="no">Countries (like to work)</td>
                            <td class="desc">{{ $user->want_country }}</td>
                        </tr>

                        <tr>
                            <td class="no">Marital Status</td>
                            <td class="desc">{{ $user->marital_status }}</td>
                        </tr>

                        <tr>
                            <td class="no">Number Of dependents</td>
                            <td class="desc">{{ $user->number_of_dependents }}</td>
                        </tr>

                        <tr>
                            <td class="no">Driver Licence From</td>
                            <td class="desc">{{ $user->driving_license_issued_from }}</td>
                        </tr>

                        <tr>
                            <td class="no">CV</td>  <td class="desc">
                            @if ($user->cv)
                          <a target="_blank" href="http://deal.test/cv/{{$user->cv}}">Preview CV {{ $user->cv }}</a>    
                            @endif</td>
                        </tr>
